...
def print_result(arr_equals_0, arr_equals_1):
    ...
    # print("second_word: ", sum(arr_equals_1) / len(arr_equals_1))
    print(sum(arr_equals_1) / len(arr_equals_1))
...
def check_data_biagram(testX_0, testY_0, testX_1, testY_1, model):  # testX, testY, data):
    ...
    results_CART_0 = model.predict(testX_0)
    results_CART_1 = model.predict(testX_1)
    ...
    for i in range(len(testY_0)):
        ...
        class_of_words = HMM_model.parsing_biagram(predict_vector_0, predict_vector_1, [testY_0[i], testY_1[i]], [results_CART_0[i], results_CART_1[i]])
...
def kross_validation():  # кросс валидация
    ...
    # parts = [all_words[:30000],  all_words[30000:]]
    parts = [all_words[:20000], all_words[20000:40000], all_words[40000:60000]]
    parts2 = [all_words[:10000], all_words[10000:20000], all_words[20000:30000], all_words[30000:40000], \
              all_words[50000:60000]]
